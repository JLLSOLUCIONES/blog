...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- He cambiado Laravel por Lara Martina pero la lengueta sigue visualizando Laravel--}}
        <title>{{ config('app.name', 'Lara Martina') }}</title>
...
<div class="max-w-6xl mx-auto">
	...
	<footer class="p-4 bg-white sm:p-6 dark:bg-gray-800" {{-- style="width: 750px;" --}}>
		<div class="md:flex md:justify-between">
			<div class="mb-6 md:mb-0 mr-4">
				<a href="http://blog.test" class="flex items-center">
					<img src="http://blog.test/img/icono.png" class="mr-0 h-10" alt="Thedisasterbox Logo">
					<span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">THE DISASTER BOX</span>
				</a>
			</div>
			<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
				<div>
					...
					<ul>
						...
						<li>
							<a href="http://blog.test" rel="nofollow"
								class="text-gray-600 hover:underline dark:text-gray-400">Shop</a>
						</li>
					</ul>
				</div>
				<div>
					...
					<ul>
						<li class="mb-4">
							<a href="{{ route('contactanos.index') }}"
								class="text-gray-600 hover:underline dark:text-gray-400">Contact</a>
						</li>
						<li>
							<a href="{{ route('principal') }}" 
								class="text-gray-600 hover:underline dark:text-gray-400">Comments</a>
						</li>
					</ul>
				</div>
				<div>
					...
					<ul>
						<li class="mb-4">
							<a href="http://blog.test" class="text-gray-600 hover:underline dark:text-gray-400">Privacy
								Policy</a>
						</li>
						<li>
							<a href="http://blog.test" class="text-gray-600 hover:underline dark:text-gray-400">Terms
								&amp; Conditions</a>
						</li>
					</ul>
				</div>
		...
		<div class="sm:flex sm:items-center sm:justify-between">
			<span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="http://blog.test" class="hover:underline">Thedisasterbox™</a>. All Rights Reserved.
			</span>
			<div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
				<a href="https://www.facebook.com/lara.martina.10" target="_blank"  class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
				...
				<a href="https://www.instagram.com/the.disasterbox" target="_blank"  class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
						<path fill-rule="evenodd"
				...
				<a href="https://www.linkedin.com/in/lara-romero-setdesign" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
					<svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" aria-hidden="true" width="20px" height="20px">
						<path fill-rule="evenodd"
		...
		<p class="mt-5 text-center">Lara Martina &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Set Disigner &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paris, France &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="text-blue-600">lara.martina8mjm@outlook.es</a>
		</p>
	<br>
</div>
</html>
