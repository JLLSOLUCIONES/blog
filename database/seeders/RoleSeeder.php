...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'admin.files.index','description' =>'Ver links Instagram'])->syncRoles([$role1]);
        Permission::create(['name' => 'admin.files.create','description' =>'Crear links Instagram'])->syncRoles([$role1]);
        Permission::create(['name' => 'admin.files.edit','description' =>'Editar links Instagram'])->syncRoles([$role1]);
        Permission::create(['name' => 'admin.files.destroy','description' =>'Eliminar links Instagram'])->syncRoles([$role1]);
